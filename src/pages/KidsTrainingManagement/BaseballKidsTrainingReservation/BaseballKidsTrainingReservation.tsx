...
const BaseballKidsTrainingReservation = () => {
  ...
  useEffect(() => {
    if (!state?.data) {
      navigate("/programs/kids-training/baseball");
    }
  }, [state]);
  ...
  return (
    <>
      <BannerSection title="Baseball Kids Training" image={baseballBanner} />
      <Container>
        <div className="lg:py-16 py-14 space-y-10">
          <div className="space-y-5">
            ...
            <p className="md:text-lg text-base md:leading-7 sm:leading-6 leading-5 text-[#929292] text-justify">
              ...
              into budding baseball stars. Our experienced coaches teach
              throwing, catching, batting, and base-running in a fun-filled
              environment that ensures learning and excitement go hand-in-hand.
              It's not just about hits and home runs; it's about building
              character and teamwork skills too!
            </p>
          </div>
          <div className="space-y-5">
            <div className="space-y-5">
...
export default BaseballKidsTrainingReservation;
