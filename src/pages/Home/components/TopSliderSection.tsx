...
const TopSliderSection = () => {
  ...
  return (
    ...
    ${
      slide.promotion
        ? "bg-[center_left] bg-[length:140%_auto] md:bg-contain"
        : "bg-[bottom_right] bg-cover"
    }
  `}
                  style={{
                ...
                >
                  <div className="lg:w-[800px] sm:space-y-10 space-y-7 md:px-16 md:mt-40 sm:px-10 px-6 sm:pb-24 pb-16 sm:pt-0 pt-20">
                    {!slide.promotion && (
                      <>
