      ...
      <div className="space-y-5">
        ...
        <ul className="list-none space-y-4">
          ...
          <li className="flex items-center gap-4">
            ...
            <p className="font-medium text-[#4B4B4B]">
              Training Session starts at $50.
            </p>
          </li>
          <li className="flex items-center gap-4">
            <PiClockCountdownLight className="size-7" />
            <p className="font-medium text-[#4B4B4B]">
              Option to purchase kids training pass inclusive of four training
              sessions and save $40 off from regular rate.
            </p>
          </li>
        </ul>
      </div>
      <div className="space-y-5">
        ...
        <ul className="list-none inclueded-list space-y-5 text-base text-[#4B4B4B] font-medium">
          <li className="flex gap-5">
            ...
            <div>
              <p>Sign up for monthly youth training sessions and get $40 off</p>
            </div>
          </li>
          <li className="flex gap-5">
            <IoIosCheckmarkCircle className="size-7 text-[#87D98B]" />
            <p>Trained by certified professional trainers.</p>
          </li>
          <li className="flex gap-5">
            <IoIosCheckmarkCircle className="size-7 text-[#87D98B]" />
          ...
          <li className="flex gap-5">
            ...
            <p>
              ...
              batting length lanes to maximize individual training needs of your
              kids.
            </p>
          </li>
          <li className="flex gap-5">
            <IoIosCheckmarkCircle className="size-7 text-[#87D98B]" />
            <p>Inbuilt nets to prevent injuries for the safety of kids.</p>
          </li>
          <li className="flex gap-5">
            <IoIosCheckmarkCircle className="size-7 text-[#87D98B]" />
            <p>
...
export default KidsBookingSidebar;
