...
import GetInMap from "../Contact/components/GetInMap";
import GetInForm from "../Contact/components/GetInForm";
import { Link, useLocation, useNavigate } from "react-router-dom";

const RentalMembership = () => {
...
export default RentalMembership;
