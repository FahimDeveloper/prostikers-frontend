...
import hockyBanner from "../../assets/images/programsBanner/hocky-banner.jpg";
...
const SportHocky = () => {
  ...
  const coachesData = {
    ...
    description:
      "Our hocky coaches are the strategic masterminds and technical experts dedicated to perfecting your pitch and refining your swing. They bring a wealth of experience from the major leagues down to developmental play.",
    coaches: [
      {
        name: "Brandon Shaw",
  ...
  return (
    <>
      <BannerSection title="Hokey Programs" image={hockyBanner} />
