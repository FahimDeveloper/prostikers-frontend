...
const JoinAsIndividualRegistration = () => {
  ...
  const onFinish = () => {
    ...
    navigate("/tournament-individual-payment", {
        ...
        <div className="lg:py-16 py-14 space-y-10">
          <div className="space-y-5">
            ...
            <p className="text-lg text-[#929292]">
              Embark on your solo cricket journey in ProStrikers’ exhilarating
              T10 League. Ideal for individual players looking to dive into
          ...
          <div className="space-y-5">
            <div className="space-y-5">
              <h2 className="font-medium sm:text-2xl text-xl">
                Tournament Individual Information
              </h2>
              <Descriptions
                bordered
                column={{
